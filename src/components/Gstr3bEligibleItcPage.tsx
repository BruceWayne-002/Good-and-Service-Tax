...
const Gstr3bEligibleItcPage: React.FC = () => {
  ...
  const handleSave = async (): Promise<boolean> => {
    ...
    try {
      ...
      const [saveResult, summaryResult] = await Promise.all([
        supabase
          .from('gstr3b_eligible_itc')
      ...
      if (summaryResult.error) {
        console.error("Summary update failed", summaryResult.error);
      }
      ...
      toast({ title: 'Save Failed', description: err.message || 'Failed to save data', variant: 'destructive' });
      return false;
    } finally {
      setSaving(false);
    }
      ...
      <main className="max-w-[1200px] mx-auto px-4 py-6 w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow border">
          ...
          <div className="mt-6 flex justify-end gap-2">
            ...
            <Button className="bg-[#234E8F] hover:bg-[#1d447e]" onClick={handleConfirm} disabled={saving}>
